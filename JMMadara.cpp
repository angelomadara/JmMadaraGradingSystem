...
void standingAve(int counter_x){
	...
	string student_midterm_grade_array[counter_x];
	string student_final_grade_array[counter_x];
	string student_remark_array[counter_x];
	...
	for (int i = 0; i < counter_x; i++)
	{
		...
		cout << endl << "Input grades for " << student_name_array[i] << ":";
		...
		student_midterm_grade_array[i] = "Your midterm grade in percentage format is : " + std::to_string(midterm_grade);
		student_final_grade_array[i] = "Your midterm grade in point format is : " + std::to_string(final_grade);
		student_remark_array[i] = "Your remark is : " + passed_or_failed;
	...
	for (int i = 0; i < counter_x; i++)
	{
		...
		cout << student_midterm_grade_array[i] << endl;
		cout << student_final_grade_array[i] << endl;
		cout << student_remark_array[i] << endl;
		cout << endl << "+----------------------------------------------------------+" << endl << endl;
	}
